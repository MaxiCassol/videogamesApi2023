...
export const getGames = () => {
    return async function (dispatch) {
        try {
            ...
            const response = await axios.get("https://videogamesapi2023-production.up.railway.app/videogames");
...
export const getGameByName = (name) => {
    return async function(dispatch){
        try {
            ...
            const info = await axios.get(`https://videogamesapi2023-production.up.railway.app/videogames?name=${name}`)
        return dispatch({
            type: GET_BY_NAME,
            payload: info.data
        })
...
export const getGenres = (payload) => {
    return async function (dispatch) {
        try {
            ...
            let response = await axios.get("https://videogamesapi2023-production.up.railway.app/genres", payload)
            return dispatch({
                type: GET_GENRES,
                payload: response.data
            });
...
export const getDetailgame = (value) => {
    return async function(dispatch){
        ...
        const gameById = await axios.get(`https://videogamesapi2023-production.up.railway.app/videogames/${value}`)
...
export const postVideogame = (res) => {
    return async function (dispatch){
        ...
        const resp = await axios.post("https://videogamesapi2023-production.up.railway.app/videogames",res)
...
export const deleteVideoGame = (id) => {
    return async function (dispatch) {
        try {
            ...
            let response = await axios.delete(`https://videogamesapi2023-production.up.railway.app/videogames/${id}`)
            return dispatch({
                type: DELETED_GAME,
                payload: response.data
            })
